...
my $inpath0 = "/etc/vdr/plugins/graphTFT/themes/DeepBlue/png0";
my $inpath1 = "/etc/vdr/plugins/graphTFT/themes/DeepBlue/png1";
my $linkpath = "/etc/vdr/plugins/graphTFT/themes/DeepBlue/columnimages";
